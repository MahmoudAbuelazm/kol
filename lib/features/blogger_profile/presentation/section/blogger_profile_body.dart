...
import '../../../user_profile/presentation/widget/story.dart';

class BloggerProfileBody extends StatelessWidget {
  const BloggerProfileBody({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              InkWell(
                onTap: () {
                  AppRouter.goRouter.pushNamed(AppRoute.bloggerRequest.name);
                },
                child: Container(
                  width: 152.w,
                  decoration: BoxDecoration(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ForwardButton(
                          onPressed: () {
                            AppRouter.goRouter.pushNamed(AppRoute.wallet.name);
                          },

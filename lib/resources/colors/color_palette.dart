...
class ColorPalette {
  static const Color primary = Color(0xff5A3392);
  ...
  static const Color  lightprimary = Color(0xffE8DBFA);
  static const Color  lightblue = Color(0xffF9F9F9);
  static const Color  lightblue2 = Color(0xffD9D9D9);
